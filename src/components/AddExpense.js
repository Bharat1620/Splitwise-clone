...
handleClick=(e)=>{
  ...
  render() {
    ...
    return (
     ...
     <center><h4>Add a expense</h4></center>
...
const mapDispatchToProps=(dispatch)=>{
  return {
    addExpense:(obj)=>{dispatch({type:'ADD_EXPENSE',obj:obj}) }
  }
}


export default connect(mapStateToProps,mapDispatchToProps)(withRouter(AddExpense));